...
def get_content_url(name):
    vid_id = {
        ...
        'Volvo Trucks Episode 6 Sustainability decarbonization through fuel efficiency [TubeRipper.com].mp3': "https://storage.googleapis.com/deep-search-demo-logs/volvo_vids/vids/vid%209.mp4",
        ...
        'Volvo Trucks Episode 8 Safety and Connectivity lead to Efficiency and Sustainability [TubeRipper.com].mp3': "https://storage.googleapis.com/deep-search-demo-logs/volvo_vids/vids/vid%207.mp4",
